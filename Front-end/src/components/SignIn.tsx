    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-md bg-[var(--card)] border border-[var(--border)] satoshi-regular">
        ...
        <div className="flex flex-col items-center space-y-4 py-6">
          <Button
            onClick={() => googleLogin()}
            className="w-full max-w-xs bg-[var(--foreground)] hover:bg-[var(--foreground)]/100 text-[var(--background)] satoshi-medium shadow-md hover:shadow-[var(--shadow-l)] py-6 cursor-pointer"
          >
            <svg
