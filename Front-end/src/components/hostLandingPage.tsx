...
const hostLandingPage = () => {
  ...
  return (
    <>
      <div className="py-12 satoshi-mdedium">
        <div className="flex  col items-center justify-center">
          <div className="max-w-4xl w-full flex flex-col items-center">
            <h1 className="text-3xl md:text-4xl lg:text-6xl satoshi-bold mt-8 text-shadow-[var(--shadow-t)] text-center leading-18">
              Become a verified host on EventSphere
            </h1>
            ...
            <Button
              ...
              className="px-4 md:px-6 py-2 bg-[var(--foreground)] hover:bg-[var(--foreground)] text-[var(--muted)] shadow-[var(--shadow-m)] text-sm md:text-md rounded-xl cursor-pointer"
            >
              Become Host
            </Button>
          </div>
        </div>
        <div className="w-full border-t border-b border-[var(--border)] my-14 -mx-8">
          <div className="sm:flex mx-auto w-full px-6 sm:max-w-[40rem] md:max-w-[48rem] md:px-8 lg:max-w-[64rem] xl:max-w-[80rem]">
            <p className="flex-auto self-center text-balance py-8 text-center text-base/6 font-book text-gray-950 sm:pr-10 sm:text-left xl:py-10">
              Trusted by fast-growing companies around the world.
            </p>
            <ul className="w-full grid grid-cols-4 gap-4">
              <li className="border-l border-[var(--border)] flex justify-center items-center">
                <svg
              ...
              <li className="border-l border-r border-[var(--border)] flex justify-center items-center">
                <Twitter />
              </li>
            </ul>
          </div>
